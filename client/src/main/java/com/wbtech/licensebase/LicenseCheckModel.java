...
public class LicenseCheckModel {
     ...
     */
    private Map<String, ModuleProperties<String, String>> models;

    public Map<String, ModuleProperties<String, String>> getModels() {
        return models;
    }

    public void setModels(Map<String, ModuleProperties<String, String>> models) {
        this.models = models;
    }
